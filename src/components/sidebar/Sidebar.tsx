  ...
  const links = [
    {
      ...
      icon: (
        <img
          src={dashboardIcon}
          alt="Dashboard"
          className=" w-[14px] h-[14px] top-[189px] left-[55px] "
        />
      ),
      className:
        "bg-[#19161c] px-4 hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] rounded-lg",
    },

    {
      ...
      className:
        "bg-[#19161c] hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] px-4 text-[#AEB9E1] rounded-lg ",
    },
    {
      label: "Users",
      href: "#",
      icon: (
        <img src={usersIcon} alt="Users" className="h-5 w-5 text-[#AEB9E1]" />
      ),
      className:
        "bg-[#19161c] px-4 hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] text-[#AEB9E1] rounded-lg ",
    },
    {
      label: "Flagged Posts",
      href: "#",
      icon: (
        <img src={postsIcon} alt="Posts" className="h-5 w-5 text-[#AEB9E1]" />
      ),
      className:
        "bg-[#19161c] px-4 hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] text-[#AEB9E1] rounded-lg ",
    },
    {
      ...
      href: "#",
      icon: (
        <img src={helpIcon} alt="Help" className="h-5 w-5 text-[#AEB9E1]" />
      ),
      className:
        "bg-[#19161c] px-4 hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] text-[#AEB9E1] rounded-lg ",
    },
    {
      ...
      href: "#",
      icon: (
        <img src={dashicon} alt="Help" className="h-5 w-5 text-[#AEB9E1] " />
      ),
      className:
        " bg-[#19161c] px-4 hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] text-[#AEB9E1] rounded-lg ",
    },
        ...
        <Sidebar open={open} setOpen={setOpen} animate={false}>
          <SidebarBody className="relative h-screen bg-[#000000] overflow-hidden">
            <img
              src={image1}
              alt="Bottom gradient"
              className="left-0 h-[100%] width-[539px] top-0 absolute"
            />
            <img
              src={image2}
              alt="Top gradient"
              className=" absolute h-[100%] width-[539px]  right-0  bottom-0"
            />
    ...
    width: 539px; */}
            ...
            <div className="relative z-10">
              <button
                ...
                className={cn(
                  "flex items-center justify-start gap-2 group/sidebar py-2 text-[#AEB9E1] hover:text-white transition-colors w-full"
                )}
              >
                <img
                  src={profileIcon}
...
export const Logo = () => {
  return (
    <div className="space-y-4">
      <img src={logosidebar} alt="WheeShare" className="rounded" />
...
const Dashboard = () => {
  return (
    <div className="flex flex-1 bg-neutral-900 p-4 sm:p-6 overflow-y-auto">
      <div className="flex h-full w-full flex-1 flex-col gap-4 sm:gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
          ...
          <div className="order-2 sm:order-none flex flex-wrap sm:flex-nowrap items-center gap-3">
            ...
            <div className="relative inline-block rounded-lg p-[2px] bg-gradient-to-r from-[#18C8FF] to-[#933FFE] w-full sm:w-auto">
              <button className="flex items-center justify-center gap-2 rounded-lg bg-[#19161C] px-4 hover:bg-gradient-to-r hover:from-[#18C8FF] hover:to-[#933FFE] py-2 text-sm text-neutral-300 hover:bg-neutral-800 w-full">
                Export data
        ...
        <div className="flex-1 bg-neutral-800/50 rounded-xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-0 mb-6">
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-semibold text-white">
                $27.8K <span className="text-green-400 text-sm">+20%</span>
              </p>
            </div>
          ...
          <div className="h-[250px] sm:h-[300px] w-full bg-gradient-to-b from-blue-500/20 to-transparent rounded-lg">
            <Revenue />
          </div>
        </div>

        {/* Users by Device and Recent Subscribers Section */}
        <UsersByDevice />
